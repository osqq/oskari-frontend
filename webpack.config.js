...
module.exports = (env, argv) => {
    ...
    const olcsPath = isProd ? path.resolve(process.cwd(), './node_modules/olcs/css/olcs.css') : path.resolve(process.cwd(), './node_modules/oskari-frontend/node_modules/olcs/css/olcs.css');
